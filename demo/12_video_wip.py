...
How to run
----------
    ./bin/run_dag.sh demo.12_video_wip --dag txt2video_min
    ./bin/run_dag.sh demo.12_video_wip --dag img2video_min
    ./bin/run_dag.sh demo.12_video_wip --dag txt2video_ic_lora_canny_min
'''
