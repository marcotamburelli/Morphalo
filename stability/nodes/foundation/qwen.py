# stability/nodes/foundation/qwen_image/qwen.py
...
from stability.cache.models import get_qwen_image
...
from stability.nodes.common.cuda_stat import (cuda_mem_stats, cuda_prerun, cuda_sync,
...
class QwenImage(PromptMixin, NodeRef):
    ...
    dict
        ...
        timing information, and (when CUDA devices are involved) memory
        statistics.
