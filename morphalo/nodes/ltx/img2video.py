...
from morphalo.nodes.ltx.conditioning import build_image_condition
...
@dataclass
class Img2Video(CudaPostRunMixin, PromptMixin, NodeRef):
    """
    ...
    Notes
    -----
    - Hugging Face cache/environment variables are configured by the DAG runner
